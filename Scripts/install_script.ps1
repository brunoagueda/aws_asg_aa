...
try{
    ...
    aws autoscaling complete-lifecycle-action --lifecycle-hook-name "scale_out" --auto-scaling-group-name "asg-teste" --lifecycle-action-result CONTINUE --instance-id $instanceID --region "us-east-1"
}
catch{
